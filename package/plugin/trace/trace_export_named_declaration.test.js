...
describe('trace/trace_export_named_declaration', function() {
  ...
  it("matches export lists", () => {
    ...
    expectMatch("const one = 1;       export { one as specifier }",   "specifier")
    expectMatch("const one = 1;       export { one as 'specifier' }", "specifier")
    expectMatch("const one = 1;       export { one as default }",     "default")
  })

  it("traces module aggregations (aka re-exports, aka barels)", () => {
    expectState("export * as specifier from './origin.js'",            "specifier", { match: { name: "*", source: "./origin.js", file: "./source.js" }, traces: [] });
    expectTrace("export { specifier } from './origin.js';",            "specifier")
    expectTrace("export { one as specifier } from './origin.js';",     "specifier", "one");
    expectTrace("export { default } from './origin.js';",              "default");
    expectTrace("export { default as specifier } from './origin.js';", "specifier", "default");
  })
});
